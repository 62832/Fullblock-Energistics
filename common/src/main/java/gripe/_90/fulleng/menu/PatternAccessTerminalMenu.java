...
public class PatternAccessTerminalMenu extends PatternAccessTermMenu {
    public static final MenuType<PatternAccessTerminalMenu> TYPE_FULLBLOCK = MenuTypeBuilder
            .create(PatternAccessTerminalMenu::new, PatternAccessTerminalBlockEntity.class)
